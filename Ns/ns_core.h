...
#ifndef MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NS_CORE_H_
#define MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NS_CORE_H_
...
typedef struct NSinst_t_ {
  ...
  Word32   blockInd;                           //frame index counter
...
#endif
#endif  // MODULES_AUDIO_PROCESSING_NS_MAIN_SOURCE_NS_CORE_H_
